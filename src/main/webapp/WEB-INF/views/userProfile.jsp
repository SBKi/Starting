				...
				<div class="profile_left">
					<div class="profile_imgbox">
						<div class="profile_imgbox1">
								<div class="filebox">
									<a href="userProfile"> <img src="/img/${user.client_img }"
				...
				<div class="profile_right">
					<div class="profile_name">
						<h2 class="h2">${user.client_id }</h2>
							<c:if test="${user.client_id !=board.whiteboard_client_id}">
		...
		<div class="pbNvD  fPMEg">
			<div class="_1XyCr  ">
				<div class="piCib">
					...
					<!-- 내정보 일경우 -->
					<c:if test="${user.client_id == sessionScope.client_id }">
