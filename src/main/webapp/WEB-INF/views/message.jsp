               ...
               <c:forEach items="${roomlist }" var="item" varStatus="status">
                  <div class="S-mcP">
                     <div class="AjEzM ">
                        ...
                        <c:if
                           test="${clientlist.get(status.count-1).client_gender eq 'M'}">
                           <div style="cursor: pointer;">
                              <i class="fas fa-male" style="width: 20px;"></i>
                           </div>
                        </c:if>
                        <c:if
                           test="${clientlist.get(status.count-1).client_gender eq 'F'}">
                           <div style="cursor: pointer;">
                              <i class="fas fa-female" style="width: 20px;"></i>
                           </div>
                        </c:if>
                     </div>
                  </div>
