				...
				<div class="follow_list">
					<div class="follow_lists">
						<div class="follow_list_user">
							...
							<div class="follow_list_button1">
								<button id="follow_delete" class="follow_list_button1">팔로잉</button>
							</div>
						</div>
					</div>
					<div class="follow_lists">
						<div class="follow_list_user">
							...
							<div class="follow_list_button1">
								<button type="button" class="follow_list_button1">팔로잉</button>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="piCib">
					<div class="modal_button_body">
						<div class="user_profile">
							...
							<div>
								<h4 class="h4">{client_id} 님을 팔로잉 취소하시겠습니까?</h4>
							</div>
						</div>
						<button class="modal_button" tabindex="0" style="font-weight:700; color: red; "
							onclick="location.href='delete'"><span>팔로잉 취소</span></button>
						<button class="modal_button" id="meaning_option" tabindex="0" style="font-weight: 700; color: red;"
...
const btnOpenPopup = document.getElementById('follow_delete');
