...
<nav class="NXc7H jLuN9  ">
	...
	<div class="_8MQSO  Cx7Bp">
		<div class="_lz6s">
			<div class="MWDvN">
				<div class="oJZym">
					<a href="/" tabindex="0"><div
							class="             qF0y9          Igw0E   rBNOH        eGOV_     ybXk5    _4EzTm                                                                                                              ">
							<div class="cq2ai">
								<img alt="#" class="s4Iyt" src="${pageContext.request.contextPath}/resources/img/logo_text.png">
							</div>
						</div></a>
				</div>
<<<<<<< HEAD
...
>>>>>>> branch 'master' of https://github.com/Advensod-KBJ/TeamProject3
				<div class="_0aCwM ">
					...
					<div class="pbgfb" role="button">
						<div class="eyXLr">
							<span class="_6RZXI coreSpriteSearchIcon"></span><span
								class="TqC_a">검색</span>
						</div>
					</div>
					<div class="yPP5B"></div>
				...
				<div class="ctQZg">
					<div class="_47KiJ">
						<div class="XrOey">
							<div class="">
								<a href="/" tabindex="0"><svg aria-label="홈" class="_8-yf5 "
										color="#262626" fill="#262626" height="22" role="img"
						...
						<div class="XrOey">
							<a aria-label="Direct 메시지 - 새로운 알림 링크 0개" class="xWeGp"
								href="/direct/inbox/" tabindex="0"><svg aria-label="Direct"
						...
						<div class="XrOey">
							<a class="wpO6b ZQScA " href="/board"> <svg
						...
						<div class="XrOey">
							<a href="/explore/" tabindex="0"><svg aria-label="사람 찾기"
									class="_8-yf5 " color="#262626" fill="#262626" height="22"
									role="img" viewBox="0 0 48 48" width="22">
						...
						<div class="XrOey">
							<a class="_0ZPOP kIKUG " href="/accounts/activity/"><svg
