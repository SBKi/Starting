	...
	<div id="login">
		<div id="body" style="padding-top: 19.5px;">
			<div class="container" style="padding-top: 28px;">
				...
				<form action="find_password_C" method="post">
					<div class="input_section">
						<input class="input" type="text" id="id" name="client_id" placeholder="아이디" required="required">
						<input class="input" type="email" id="email" name="client_email" placeholder="본인 이메일(주소)" required="required">
