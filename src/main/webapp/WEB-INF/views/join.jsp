...
<body>
		...
		<div id="body" style="padding-top: 19.5px;">
			<div class="container" style="padding-top: 28px;">
				<div class="instagram_logo">
					<img th:src="${pageContext.request.contextPath}/resources/img/logo.jpg}"
	...
	<script th:src="${pageContext.request.contextPath}/resources/js/main.js}"  type="text/javascript"></script>
